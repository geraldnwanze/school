...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">School Fee Attributes</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="./">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page">School Fee Attributes</li>
      </ol>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
                  <form method="post" action="{{ route('school-fees.attributes.store') }}">
                      @csrf
                ...
                <tbody>
                    @forelse ($attributes as $attribute)
                        <tr role="row" class="odd">
                            ...
                            <td>
                                <button type="button" class="mx-3 btn btn-warning btn-sm" data-toggle="modal" data-target="#classroomEditModal-{{ $attribute->id }}">
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="classroomEditModal-{{ $attribute->id }}" tabindex="-1" role="dialog" aria-labelledby="classroomEditModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <form method="post" action="{{ route('school-fees.update', $attribute->id) }}">
                                                    @csrf
                                                    @method('PATCH')
                                                    <div class="form-group row mb-3">
                                                        <div class="col-xl-6">
                                                            <label class="form-control-label">Name<span class="text-danger ml-2">*</span></label>
                                                            <input type="text" class="form-control" name="name" id="exampleInputFirstName" placeholder="" value="{{ $attribute->name }}">
                                                        </div>
                                                        <div class="col-xl-6">
                                                            <label class="form-control-label">Amount<span class="text-danger ml-2">*</span></label>
                                                            <input type="number" class="form-control" name="amount" id="exampleInputFirstName" placeholder="" value="{{ $attribute->amount }}">
                                                        </div>
                                                    </div>

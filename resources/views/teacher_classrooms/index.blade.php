...
<div class="container-fluid" id="container-wrapper">
        ...
        <div class="col-lg-12">
          ...
          <div class="card mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Assign class to teacher</h6>
          </div>
            <div class="card-body">
                          ...
                          <div class="col-xl-6">
                            ...
                            <br>
                                @forelse ($classes as $class)
                                        <input type="checkbox" name="classroom_id[]" value="{{ $class->id }}" > {{ $class->name }} &nbsp;
                                @empty
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Teachers and classes</h6>
          </div>
            ...
            <div id="dataTableHover_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
              ...
              <thead class="thead-light">
                <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="dataTableHover" rowspan="1" colspan="1" aria-label="Class Name: activate to sort column ascending" style="width: 328.922px;">Classes</th>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <form method="post" action="{{ route('teacher-classrooms.update', $teacher->id) }}">
                                                    @csrf
                                                    @method('PATCH')
                                                    <div class="form-group row mb-3">
                                                        <div class="col-xl-6">
                                                        ...
                                                        <div class="col-xl-6">
                                                          ...
                                                          <br>
                                                              @forelse ($classes as $class)
                                                                    ...
                                                                    <input type="checkbox" name="classroom_id[]" value="{{ $class->id }}"
                                                                    @foreach ($teacher->classrooms as $classroom)
                                                                        {{ $classroom->id == $class->id ? 'checked' : '' }}
                                                                    @endforeach
                                                                    > {{ $class->name }} &nbsp;
